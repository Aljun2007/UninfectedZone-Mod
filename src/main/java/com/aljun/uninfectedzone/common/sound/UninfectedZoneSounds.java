...
public class UninfectedZoneSounds {
    ...
    public static void register(IForgeRegistry<SoundEvent> registry) {
        ...
        CUSTOM_ZOMBIE_AMBIENT = register(registry, () -> new SoundEvent(new ResourceLocation(UninfectedZone.MOD_ID, "entity.custom_zombie.ambient")), "custom_zombie_hurt");
        ...
        CUSTOM_ZOMBIE_STEP = register(registry, () -> new SoundEvent(new ResourceLocation(UninfectedZone.MOD_ID, "entity.custom_zombie.hurt")), "custom_zombie_hurt");
    }
