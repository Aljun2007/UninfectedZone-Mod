...
public class UninfectedZoneLootItemConditions {
    public static final LootItemConditionType LOADED_GUN_AMMO_ATTACHMENT =
            new LootItemConditionType(new TACZLoadedGunAmmoAttachmentCondition.Serializer());
    ...
    public static void register() {
        Registry.register(Registry.LOOT_CONDITION_TYPE, new ResourceLocation(UninfectedZone.MOD_ID, "tacz_loaded_guns_ammo_attachments"), LOADED_GUN_AMMO_ATTACHMENT);
